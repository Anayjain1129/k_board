...
title: K_Board
author: Anay
description: A fully customised keyboard from scratch
created_at: "2026-05-23"
---

# May 3rd: Started with schematics and brainstormed a basic idea! 

I'm using KiCad to make this keyboard Started wtih schematics brainstormed for a basic/rough idea of what layout i have to use! placed the components, wirted a lil bit! read about keyboard mounting styles
lapse link: https://lapse.hackclub.com/timelapse/YrQlb_RHFgfU
...
# May 10th: Switches model assigned & PCB ready for redering 
just assigned 3d models of all the switches in the PCB, there were few places where wiring was not done, so i wierd them too! now the PCB is ready for rendering (looks pretty).
